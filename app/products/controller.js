...
//             values: [users_id, name, price, stock, status, path.join(`http://localhost:3000/public/${image.originalname}`) ]
//         }, _response(res))
//      }
//  }
...
//         values = [users_id, name, price, stock, status, path.join( `http://localhost:3000/public/${image.originalname}`),req.params.id]
//     } else {
